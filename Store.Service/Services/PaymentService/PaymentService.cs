...
{
    public class PaymentService : IPaymenyService
    {
        ...
        public async Task<CustomerBasketDto> CreatOrUpdatePaymentIntent(CustomerBasketDto basket)
        {
        ...
        public async Task<OrderDetailsDto> UpdateOrderPaymentFailed(string paymentIntentId)
        {
            ...
            order.OrderPaymetStatus = OrderPaymetStatus.Failed;
        ...
        public async Task<OrderDetailsDto> UpdateOrderPaymentSucceeded(string paymentIntentId)
        {
            ...
            order.OrderPaymetStatus = OrderPaymetStatus.Received;
